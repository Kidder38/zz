/**
 * Nový, čistý PDF generátor bez duplicitního číslování stránek
 * Používá Puppeteer s jednoduchou konfigurací
 */
...
/**
 * Mapování label pro kontrolní položky
 */
...
const generateRevisionPdf = async (revision, equipment, customer, configuration, outputStream) => {
  try {
    console.log('Generování PDF s novým čistým generátorem...');
    ...
    // Nastavení obsahu stránky (bez screen emulation - necháme print media)
    await page.setContent(html, { waitUntil: 'networkidle0' });
    
    // Generování PDF s optimalizací pro stránkování
    const pdfBuffer = await page.pdf({
      ...
      margin: {
        top: '1.5cm',
        right: '1.5cm', 
        bottom: '2.5cm',  // více místa pro CSS číslování
        left: '1.5cm'
      }
    });
    ...
    console.log('PDF úspěšně vygenerováno čistým generátorem.');
